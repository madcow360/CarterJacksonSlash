...
\end{itemize}
The Winner of this Wager is the Party;
\begin{itemize}
  \item Called upon it first time and completed it. 
  \item You have called upon it less times than the other party when it is completed.
\end{itemize}
\end{samepage}
\newpage
\input{E09} 